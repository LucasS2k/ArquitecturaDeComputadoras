...
lazo: in al,PA
cmp al,patron
jz lazo ;si es el mismo me quedo en este loop hasta que cambie
jmp loop ;al cambiar salto hacia arriba a esperar que las llaves coincidan con el patron de nuevo
int 0
